...
static const struct button_mapping button_context_standard[]  = {
    ...
    { ACTION_STD_QUICKSCREEN,   BUTTON_REC|BUTTON_RIGHT,       BUTTON_REC },
...
static const struct button_mapping button_context_recscreen[]  = {
    { ACTION_STD_MENU,          BUTTON_POWER|BUTTON_REL,        BUTTON_POWER  },
    { ACTION_REC_PAUSE,         BUTTON_RIGHT|BUTTON_REL,       BUTTON_RIGHT },
...
static const struct button_mapping button_context_radio[]  = {
    ...
    { ACTION_FM_PRESET,         BUTTON_RIGHT,                  BUTTON_NONE },
...
static const struct button_mapping button_context_keyboard[]  = {
    ...
    { ACTION_KBD_PAGE_FLIP,    BUTTON_RIGHT|BUTTON_RIGHT,      BUTTON_RIGHT },
    { ACTION_KBD_PAGE_FLIP,    BUTTON_RIGHT|BUTTON_LEFT,       BUTTON_RIGHT },
